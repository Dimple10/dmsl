...
#        MassProfile=ps, usefraction=False, nchains=64, ndims=2, bcutoff={'SNR':
#            10.})
...
#       MassProfile=ps, usefraction=True, nchains=128, ndims=2, bcutoff={'SNR':
#       10.})
#print('This took',str(datetime.datetime.now()-time1))
...
s = Sampler(nstars=int(nn), ntune=int(1e3), nsamples=int(5e3), survey=roman,
        MassProfile=mgauss, usefraction=False, nchains=128, ndims=2,
        bcutoff={'SNR': 10.})
print('This took',str(datetime.datetime.now()-time1))
